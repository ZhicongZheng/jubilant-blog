<template>
  <div class="menu">
    ...
    <div class="menu-item" :class="{ active: route.meta.title === '首页' }">
      <router-link to="/" class="menu-btn"> <svg-icon icon-class="home" /> 首页 </router-link>
    </div>
    <div class="menu-item dropdown">
      <a class="menu-btn drop"> <svg-icon icon-class="article" /> 文章 </a>
      <ul class="submenu">
        <li class="subitem" :class="{ active: route.meta.title === '归档' }">
          <router-link class="link" to="/archive"> <svg-icon icon-class="archives" /> 归档 </router-link>
        </li>
        <li class="subitem" :class="{ active: route.meta.title === '分类' }">
          <router-link class="link" to="/category"> <svg-icon icon-class="category" /> 分类 </router-link>
        </li>
        <li class="subitem" :class="{ active: route.meta.title === '标签' }">
          <router-link class="link" to="/tag"> <svg-icon icon-class="tag" /> 标签 </router-link>
        </li>
      </ul>
    </div>
    <!--    <div class="menu-item dropdown">-->
