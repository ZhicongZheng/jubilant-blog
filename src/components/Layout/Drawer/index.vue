    ...
    <n-drawer-content style="padding-top: 0.5rem">
      ...
      <ul class="side-menu">
        <li class="item" :class="{ active: route.path === '/' }">
          <router-link to="/"><svg-icon icon-class="home" /> 首页 </router-link>
        </li>
        <li class="item dropdown" :class="{ expand: articleExpand(route.meta.title as string) }">
          <a><svg-icon icon-class="article" /> 文章</a>
          <ul class="submenu">
            <li class="item" :class="{ active: route.path === '/archive' }">
              <router-link to="/archive"> <svg-icon icon-class="archives" /> 归档 </router-link>
            </li>
            <li class="item" :class="{ active: route.path === '/category' }">
              <router-link to="/category"> <svg-icon icon-class="category" /> 分类 </router-link>
            </li>
            <li class="item" :class="{ active: route.path === '/tag' }">
              <router-link to="/tag"><svg-icon icon-class="tag" /> 标签</router-link>
            </li>
          </ul>
        </li>
