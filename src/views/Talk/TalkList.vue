      ...
      >
        ...
        <div class="info" style="margin-top: 0.5rem">
          ...
          <span class="talk-like info">
            <svg-icon icon-class="like" size="0.8rem" style="margin-right: 5px" />{{ talk.likeCount }}
          </span>
          <!-- 评论量 -->
          <span class="talk-comment info">
            <svg-icon icon-class="comment" size="0.9rem" style="margin-right: 5px" />{{ talk.commentCount }}
          </span>
        </div>
      </router-link>
