...
export const CommentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 添加一条评论
         * @summary 添加一条评论
         * @param {CommentCommand} commentCommand 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addComment: async (commentCommand: CommentCommand, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'commentCommand' is not null or undefined
            if (commentCommand === null || commentCommand === undefined) {
                throw new RequiredError('commentCommand','Required parameter commentCommand was null or undefined when calling addComment.');
            }
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const nonString = typeof commentCommand !== 'string';
            const needsSerialization = nonString && configuration && configuration.isJsonMime
                ? configuration.isJsonMime(localVarRequestOptions.headers['Content-Type'])
                : nonString;
            localVarRequestOptions.data =  needsSerialization
                ? JSON.stringify(commentCommand !== undefined ? commentCommand : {})
                : (commentCommand || "");
...
export const CommentsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async addComment(commentCommand: CommentCommand, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await CommentsApiAxiosParamCreator(configuration).addComment(commentCommand, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CommentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        addComment(commentCommand: CommentCommand, options?: any): AxiosPromise<void> {
            return CommentsApiFp(configuration).addComment(commentCommand, options).then((request) => request(axios, basePath));
        },
        /**
         * 根据id删除评论
         * @summary 删除评论
...
export class CommentsApi extends BaseAPI {
     ...
     */
    public addComment(commentCommand: CommentCommand, options?: any) {
        return CommentsApiFp(this.configuration).addComment(commentCommand, options).then((request) => request(this.axios, this.basePath));
    }
